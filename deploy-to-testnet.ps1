...
Write-Host ""
Write-Host "🏗️  Step 2: Deploying contract instance..." -ForegroundColor Cyan
try {
  ...
  Write-Host "🏷️  Contract ID: $contractId" -ForegroundColor Yellow
...
Write-Host ""
Write-Host "⚙️  Step 3: Initializing contract..." -ForegroundColor Cyan
...
Write-Host "🏷️  Contract ID: $contractId" -ForegroundColor White
