          ...
          <div className="relative w-full">
            ...
            >
              <h2 className="text-[12vw] font-medium leading-[0.95] tracking-tighter text-foreground md:text-[10vw] lg:text-[8vw] text-center px-6">
                International & Indian Operations.
              </h2>
            </div>
            ...
            <div className="relative z-10 grid grid-cols-1 gap-4 px-6 md:grid-cols-2 md:px-12 lg:px-20">
              ...
              >
                <Image
                  src="/images/international-ops.png"
                  alt="International operations - Web3 authentication and DST trading"
                  fill
              ...
              >
                <Image
                  src="/images/indian-ops.png"
                  alt="Indian operations - KYC compliance and regulatory framework"
                  fill
                  className="object-cover"
                />
                <div className="absolute bottom-6 left-6">
      ...
      <div className="px-6 py-20 md:px-12 md:py-28 lg:px-20 lg:py-36 lg:pb-14">
        <div className="text-center">
          ...
          <p className="mt-8 leading-relaxed text-muted-foreground text-3xl text-center">
            <strong>International:</strong> Web3 authentication, DST trading only, no physical redemption, KYC applied where required.
            <br /><br />
            <strong>Indian:</strong> Full compliance framework with jurisdictional KYC requirements.
            <br /><br />
            <strong>Core Commitment:</strong> No token is minted unless corresponding physical silver is acquired, verified, and securely stored.
          </p>
        </div>
      </div>
    </section>
